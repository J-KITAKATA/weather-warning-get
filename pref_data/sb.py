...
# エリアのキーとコード
area_id = {"SN":"016031", "YS":"016032", "SW":"016033"}
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 後志地方
        p_data = "**" + pn + "**\n"
        target_code = "016030" # 後志地方のターゲットコード
        ...
        # 後志北部
        p_data = "**" + pn + " 後志北部**\n"
        target_code = area_id[area] # 後志北部 のターゲットコード
        ...
        # 羊蹄山麓
        p_data = "**" + pn + " 羊蹄山麓**\n"
        target_code = area_id[area] # 羊蹄山麓 のターゲットコード
        ...
        # 後志西部
        p_data = "**" + pn + " 後志西部**\n"
        target_code = area_id[area] # 後志西部 のターゲットコード
