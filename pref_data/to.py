...
# エリアのキーとコード
area_id = {"23W":"130011", "23E":"130012", "TN":"130013", "TW":"130014", "TS":"130015", "OL":"130021", "NL":"130022", "HJ":"130031", "MY":"130032", "OG":"130040"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/tokyo_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 東京地方
        p_data = "**" + pn + " 東京地方**\n"
        target_code = "130010" # 東京地方のターゲットコード
        ...
        # 伊豆諸島北部
        p_data = p_data + "\n" + "**" + pn + " 伊豆諸島北部**\n"
        target_code = "130020" # 伊豆諸島北部のターゲットコード
        ...
        # 伊豆諸島南部
        p_data = p_data + "\n" + "**" + pn + " 伊豆諸島南部**\n"
        target_code = "130030" # 伊豆諸島南部のターゲットコード
        ...
        # 23区西部
        p_data = "**" + pn + " 23区西部**\n"
        target_code = area_id[area] # 23区西部のターゲットコード
        ...
        # 23区東部
        p_data = "**" + pn + " 23区東部**\n"
        target_code = area_id[area] # 23区東部のターゲットコード
        ...
        # 多摩北部
        p_data = "**" + pn + " 多摩北部**\n"
        target_code = area_id[area] # 多摩北部のターゲットコード
        ...
        # 多摩西部
        p_data = "**" + pn + " 多摩西部**\n"
        target_code = area_id[area] # 多摩西部のターゲットコード
        ...
        # 多摩南部
        p_data = "**" + pn + " 多摩南部**\n"
        target_code = area_id[area] # 多摩南部のターゲットコード
        ...
        # 大島
        p_data = "**" + pn + " 大島**\n"
        target_code = area_id[area] # 大島のターゲットコード
        ...
        # 新島
        p_data = "**" + pn + " 新島**\n"
        target_code = area_id[area] # 新島のターゲットコード
        ...
        # 八丈島
        p_data = "**" + pn + " 八丈島**\n"
        target_code = area_id[area] # 八丈島のターゲットコード
        ...
        # 三宅島
        p_data = "**" + pn + " 三宅島**\n"
        target_code = area_id[area] # 三宅島のターゲットコード
        ...
        # 小笠原諸島
        p_data = "**" + pn + " 小笠原諸島**\n"
        target_code = area_id[area] # 小笠原諸島のターゲットコード
