...
# エリアのキーとコード
area_id = {"HK":"340011", "FM":"340012", "HT":"340013", "BH":"340021", "GH":"340022"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/hiroshima_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 北部
        p_data = "**" + pn + " 北部**\n"
        target_code = "340020" # 北部のターゲットコード
        ...
        # 南部
        p_data = p_data + "\n" + "**" + pn + " 南部**\n"
        target_code = "340010" # 南部のターゲットコード
        ...
        # 広島・呉
        p_data = "**" + pn + " 広島・呉**\n"
        target_code = area_id[area] # 広島・呉のターゲットコード
        ...
        # 福山・尾三
        p_data = "**" + pn + " 福山・尾三**\n"
        target_code = area_id[area] # 福山・尾三のターゲットコード
        ...
        # 東広島・竹原
        p_data = "**" + pn + " 東広島・竹原**\n"
        target_code = area_id[area] # 東広島・竹原のターゲットコード
        ...
        # 備北
        p_data = "**" + pn + " 備北**\n"
        target_code = area_id[area] # 備北のターゲットコード
        ...
        # 芸北
        p_data = "**" + pn + " 芸北**\n"
        target_code = area_id[area] # 芸北のターゲットコード
