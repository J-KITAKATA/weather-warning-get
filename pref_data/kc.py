...
# エリアのキーとコード
area_id = {"KC":"390011", "MN":"390012", "KN":"390013", "MT":"390021", "AK":"390022", "HT":"390031", "TT":"390032"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/kouchi_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 中部
        p_data = "**" + pn + " 中部**\n"
        target_code = "390010" # 中部のターゲットコード
        ...
        # 東部
        p_data = p_data + "\n" + "**" + pn + " 東部**\n"
        target_code = "390020" # 東部のターゲットコード
        ...
        # 西部
        p_data = p_data + "\n" + "**" + pn + " 西部**\n"
        target_code = "390030" # 西部のターゲットコード
        ...
        # 高知中央
        p_data = "**" + pn + " 高知中央**\n"
        target_code = area_id[area] # 群馬県 高知中央のターゲットコード
        ...
        # 峯北
        p_data = "**" + pn + " 峯北**\n"
        target_code = area_id[area] # 峯北のターゲットコード
        ...
        # 高吾北
        p_data = "**" + pn + " 高吾北**\n"
        target_code = area_id[area] # 高吾北のターゲットコード
        ...
        # 室戸
        p_data = "**" + pn + " 室戸**\n"
        target_code = area_id[area] # 室戸のターゲットコード
        ...
        # 安芸
        p_data = "**" + pn + " 安芸**\n"
        target_code = area_id[area] # 安芸のターゲットコード
        ...
        # 幡多
        p_data = "**" + pn + " 幡多**\n"
        target_code = area_id[area] # 幡多のターゲットコード
        ...
        # 高幡
        p_data = "**" + pn + " 高幡**\n"
        target_code = area_id[area] # 高幡のターゲットコード
