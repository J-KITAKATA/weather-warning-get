...
# エリアのキーとコード
area_id = {"IW":"015011", "IC":"015012", "IE":"015013"}
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 胆振地方
        p_data = "**" + pn + "**\n"
        target_code = "015010" # 胆振地方のターゲットコード
        ...
        # 胆振西部
        p_data = "**" + pn + " 胆振西部**\n"
        target_code = area_id[area] # 胆振西部 のターゲットコード
        ...
        # 胆振中部
        p_data = "**" + pn + " 胆振中部**\n"
        target_code = area_id[area] # 胆振中部 のターゲットコード
        ...
        # 胆振東部
        p_data = "**" + pn + " 胆振東部**\n"
        target_code = area_id[area] # 胆振東部 のターゲットコード
