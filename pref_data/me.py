...
# エリアのキーとコード
area_id = {"MC":"240011", "MN":"240012", "IG":"240013", "IS":"240021", "KE":"240022"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/mie_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 北中部
        p_data = "**" + pn + " 北中部**\n"
        target_code = "240010" # 北中部のターゲットコード
        ...
        # 南部
        p_data = p_data + "\n" + "**" + pn + " 南部**\n"
        target_code = "240020" # 南部のターゲットコード
        ...
        # 伊賀
        p_data = "**" + pn + " 伊賀**\n"
        target_code = area_id[area] # 伊賀のターゲットコード
        ...
        # 伊勢志摩
        p_data = "**" + pn + " 伊勢志摩**\n"
        target_code = area_id[area] # 伊勢志摩のターゲットコード
        ...
        # 紀伊・東紀州
        p_data = "**" + pn + " 紀伊・東紀州**\n"
        target_code = area_id[area] # 紀伊・東紀州のターゲットコード
