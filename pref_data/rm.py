...
# エリアのキーとコード
area_id = {"RN":"012021", "RC":"012022", "RS":"012023"}
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 留萌地方
        p_data = "**" + kmh + "**\n"
        target_code = "012020" # 留萌地方のターゲットコード
        ...
        # 留萌北部
        p_data = "**" + kmh + " 留萌北部**\n"
        target_code = area_id[area] # 留萌北部 のターゲットコード
        ...
        # 留萌中部
        p_data = "**" + kmh + " 留萌中部**\n"
        target_code = area_id[area] # 留萌中部 のターゲットコード
        ...
        # 留萌南部
        p_data = "**" + kmh + " 留萌南部**\n"
        target_code = area_id[area] # 留萌南部 のターゲットコード
