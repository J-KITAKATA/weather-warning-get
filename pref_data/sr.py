...
# エリアのキーとコード
area_id = {"NS":"016021", "CS":"016022", "SS":"016023"}
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 空知地方
        p_data = "**" + pn + "**\n"
        target_code = "016020" # 空知地方のターゲットコード
        ...
        # 北空知
        p_data = "**" + pn + " 北空知**\n"
        target_code = area_id[area] # 北空知 のターゲットコード
        ...
        # 中空知
        p_data = "**" + pn + " 中空知**\n"
        target_code = area_id[area] # 中空知 のターゲットコード
        ...
        # 南空知
        p_data = "**" + pn + " 南空知**\n"
        target_code = area_id[area] # 南空知 のターゲットコード
