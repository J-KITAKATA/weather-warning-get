...
# エリアのキーとコード
area_id = {"SE":"160011", "NE":"160012", "NW":"160021", "SW":"160022"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/toyama_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 東部
        p_data = "**" + pn + " 東部**\n"
        target_code = "160010" # 東部のターゲットコード
        ...
        # 西部
        p_data = p_data + "\n" + "**" + pn + " 西部**\n"
        target_code = "160020" # 西部のターゲットコード
        ...
        # 東部南
        p_data = "**" + pn + " 東部南**\n"
        target_code = area_id[area] # 東部南のターゲットコード
        ...
        # 東部北
        p_data = "**" + pn + " 東部北**\n"
        target_code = area_id[area] # 東部北のターゲットコード
        ...
        # 西部北
        p_data = "**" + pn + " 西部北**\n"
        target_code = area_id[area] # 西部北のターゲットコード
        ...
        # 西部南
        p_data = "**" + pn + " 西部南**\n"
        target_code = area_id[area] # 西部南のターゲットコード
