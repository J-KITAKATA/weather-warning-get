...
# エリアのキーとコード
area_id = {"OS":"270001", "NO":"270002", "EO":"270003", "SK":"270004", "SN":"270005"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/osaka_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 大阪府
        p_data = "**" + pn + "**\n"
        target_code = "270000" # 大阪府のターゲットコード
        ...
        # 大阪市
        p_data = "**" + pn + " 大阪市**\n"
        target_code = area_id[area] # 大阪市のターゲットコード
        ...
        # 北大阪市
        p_data = "**" + pn + " 北大阪市**\n"
        target_code = area_id[area] # 北大阪市のターゲットコード
        ...
        # 東部大阪
        p_data = "**" + pn + " 東部大阪**\n"
        target_code = area_id[area] # 東部大阪のターゲットコード
        ...
        # 南河内
        p_data = "**" + pn + " 南河内**\n"
        target_code = area_id[area] # 南河内のターゲットコード
        ...
        # 泉州
        p_data = "**" + pn + " 泉州**\n"
        target_code = area_id[area] # 泉州のターゲットコード
