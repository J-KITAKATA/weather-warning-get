...
# エリアのキーとコード
area_id = {"CN":"190011", "KE":"190012", "KS":"190013", "YE":"190021", "FG":"190022"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/yamanashi_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 中・西部
        p_data = "**" + pn + " 中・西部**\n"
        target_code = "190010" # 中・西部のターゲットコード
        ...
        # 東部・富士五湖
        p_data = p_data + "\n" + "**" + pn + " 東部・富士五湖**\n"
        target_code = "190020" # 東部・富士五湖のターゲットコード
        ...
        # 中北地域
        p_data = "**" + pn + " 中北地域**\n"
        target_code = area_id[area] # 中北地域のターゲットコード
        ...
        # 峡東地域
        p_data = "**" + pn + " 峡東地域**\n"
        target_code = area_id[area] # 峡東地域のターゲットコード
        ...
        # 峡南地域
        p_data = "**" + pn + " 峡南地域**\n"
        target_code = area_id[area] # 峡南地域のターゲットコード
        ...
        # 東部
        p_data = "**" + pn + " 東部**\n"
        target_code = area_id[area] # 東部のターゲットコード
        ...
        # 富士五湖
        p_data = "**" + pn + " 富士五湖**\n"
        target_code = area_id[area] # 富士五湖のターゲットコード
