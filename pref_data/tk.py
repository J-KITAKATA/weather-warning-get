...
# エリアのキーとコード
area_id = {"TN":"014031", "TC":"014032", "TS":"014033"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/Tokachi-H_cache.json"
# フォルダを作成（すでにあればスルー）
# os.makedirs(os.path.dirname(CACHE_FILE), exist_ok=True)

safe_text = "警報・注意報の発表なし" # 発表されていない時用の出力

pn = "北海道 十勝地方" # 地域・エリアの名前
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 十勝地方
        p_data = "**" + pn + "**\n"
        target_code = "014030" # 十勝地方のターゲットコード
        ...
        # 十勝北部
        p_data = "**" + pn + " 十勝北部**\n"
        target_code = area_id[area] # 十勝北部 のターゲットコード
        ...
        # 十勝中部
        p_data = "**" + pn + " 十勝中部**\n"
        target_code = area_id[area] # 十勝中部 のターゲットコード
        ...
        # 十勝南部
        p_data = "**" + pn + " 十勝南部**\n"
        target_code = area_id[area] # 十勝南部 のターゲットコード
