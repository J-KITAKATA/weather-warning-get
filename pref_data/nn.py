...
# エリアのキーとコード
area_id = {"NN":"200011", "NI":"200012", "ON":"200013", "UE":"200021", "SK":"200022", "MT":"200023", "KT":"200024", "SW":"200025", "KW":"200031", "KO":"200032", "SI":"200033"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/nagano_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 北部
        p_data = "**" + pn + " 北部**\n"
        target_code = "200010" # 北部のターゲットコード
        ...
        # 中部
        p_data = p_data + "\n" + "**" + pn + " 中部**\n"
        target_code = "200020" # 中部のターゲットコード
        ...
        # 南部
        p_data = p_data + "\n" + "**" + pn + " 南部**\n"
        target_code = "200030" # 南部のターゲットコード
        ...
        # 長野地域
        p_data = "**" + pn + " 長野地域**\n"
        target_code = area_id[area] # 長野地域のターゲットコード
        ...
        # 中野飯山地域
        p_data = "**" + pn + " 中野飯山地域**\n"
        target_code = area_id[area] # 中野飯山地域のターゲットコード
        ...
        # 大北地域
        p_data = "**" + pn + " 大北地域**\n"
        target_code = area_id[area] # 大北地域のターゲットコード
        ...
        # 上田地域
        p_data = "**" + pn + " 上田地域**\n"
        target_code = area_id[area] # 上田地域のターゲットコード
        ...
        # 佐久地域
        p_data = "**" + pn + " 佐久地域**\n"
        target_code = area_id[area] # 佐久地域のターゲットコード
        ...
        # 松本地域
        p_data = "**" + pn + " 松本地域**\n"
        target_code = area_id[area] # 松本地域のターゲットコード
        ...
        # 乗鞍上高地地域
        p_data = "**" + pn + " 乗鞍上高地地域**\n"
        target_code = area_id[area] # 乗鞍上高地地域のターゲットコード
        ...
        # 諏訪地域
        p_data = "**" + pn + " 諏訪地域**\n"
        target_code = area_id[area] # 諏訪地域のターゲットコード
        ...
        # 上伊那地域
        p_data = "**" + pn + " 上伊那地域**\n"
        target_code = area_id[area] # 上伊那地域のターゲットコード
        ...
        # 木曾地域
        p_data = "**" + pn + " 木曾地域**\n"
        target_code = area_id[area] # 木曾地域のターゲットコード
        ...
        # 下伊那地域
        p_data = "**" + pn + " 下伊那地域**\n"
        target_code = area_id[area] # 群馬県 下伊那地域のターゲットコード
        ...
        # 下伊那地域
        p_data = "**" + pn + " 下伊那地域**\n"
        target_code = area_id[area] # 下伊那地域のターゲットコード
