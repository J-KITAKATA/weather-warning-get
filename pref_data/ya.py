...
# エリアのキーとコード
area_id = {"SEM":"060011", "NM":"060012", "WM":"060013", "SEO":"060021", "WO":"060022", "SN":"060031", "SS":"060032", "MG":"060040"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/yamagata_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 村山
        p_data = "**" + pn + " 村山**\n"
        target_code = "060010" # 村山のターゲットコード
        ...
        # 置賜
        p_data = p_data + "\n" + "**" + pn + " 置賜**\n"
        target_code = "060020" # 置賜のターゲットコード
        ...
        # 庄内
        p_data = p_data + "\n" + "**" + pn + " 庄内**\n"
        target_code = "060030" # 庄内のターゲットコード
        ...
        # 最上
        p_data = p_data + "\n" + "**" + pn + " 最上**\n"
        target_code = "060040" # 最上のターゲットコード
        ...
        # 東南村山
        p_data = "**" + pn + " 東南村山**\n"
        target_code = area_id[area] # 東南村山のターゲットコード
        ...
        # 北村山
        p_data = "**" + pn + " 北村山**\n"
        target_code = area_id[area] # 北村山のターゲットコード
        ...
        # 東南置賜
        p_data = "**" + pn + " 東南置賜**\n"
        target_code = area_id[area] # 東南置賜のターゲットコード
        ...
        # 西置賜
        p_data = "**" + pn + " 西置賜**\n"
        target_code = area_id[area] # 西置賜のターゲットコード
        ...
        # 庄内北部
        p_data = "**" + pn + " 庄内北部**\n"
        target_code = area_id[area] # 庄内北部のターゲットコード
        ...
        # 庄内南部
        p_data = "**" + pn + " 庄内南部**\n"
        target_code = area_id[area] # 庄内南部のターゲットコード
        ...
        # 最上
        p_data = "**" + pn + " 最上**\n"
        target_code = area_id[area] # 最上のターゲットコード
