...
# エリアのキーとコード
area_id = {"KS":"250011", "EK":"250012", "KG":"250013", "KW":"250021", "LN":"250022", "LE":"250023"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/siga_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 北部
        p_data = "**" + pn + " 北部**\n"
        target_code = "250020" # 北部のターゲットコード
        ...
        # 南部
        p_data = p_data + "\n" + "**" + pn + " 南部**\n"
        target_code = "250010" # 南部のターゲットコード
        ...
        # 近江南部
        p_data = "**" + pn + " 近江南部**\n"
        target_code = area_id[area] # 近江南部のターゲットコード
        ...
        # 東近江
        p_data = "**" + pn + " 東近江**\n"
        target_code = area_id[area] # 東近江のターゲットコード
        ...
        # 甲賀
        p_data = "**" + pn + " 甲賀**\n"
        target_code = area_id[area] # 甲賀のターゲットコード
        ...
        # 近江西部
        p_data = "**" + pn + " 近江西部**\n"
        target_code = area_id[area] # 近江西部のターゲットコード
        ...
        # 湖北
        p_data = "**" + pn + " 湖北**\n"
        target_code = area_id[area] # 湖北のターゲットコード
        ...
        # 湖東
        p_data = "**" + pn + " 湖東**\n"
        target_code = area_id[area] # 湖東のターゲットコード
