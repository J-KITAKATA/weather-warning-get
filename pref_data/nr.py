...
# エリアのキーとコード
area_id = {"NW":"290011", "NE":"290012", "GY":"290013", "SE":"290021", "SW":"290022"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/nara_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 北部
        p_data = "**" + pn + " 北部**\n"
        target_code = "290010" # 北部のターゲットコード
        ...
        # 南部
        p_data = p_data + "\n" + "**" + pn + " 南部**\n"
        target_code = "290020" # 南部のターゲットコード
        ...
        # 五條・北部吉野
        p_data = "**" + pn + " 五條・北部吉野**\n"
        target_code = area_id[area] # 五條・北部吉野のターゲットコード
