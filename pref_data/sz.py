...
# エリアのキーとコード
area_id = {"CS":"220011", "CN":"220012", "ZN":"220021", "ZS":"220022", "SE":"220031", "SW":"220032", "EN":"220041", "ES":"220042"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/shizuoka_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 中部
        p_data = "**" + szs + " 中部**\n"
        target_code = "220010" # 静岡県中部のターゲットコード
        ...
        # 伊豆
        p_data = p_data + "\n" + "**" + szs + " 伊豆**\n"
        target_code = "220020" # 静岡県伊豆のターゲットコード
        ...
        # 東部
        p_data = p_data + "\n" + "**" + szs + " 東部**\n"
        target_code = "220030" # 静岡県東部のターゲットコード
        ...
        # 西部
        p_data = p_data + "\n" + "**" + szs + " 西部**\n"
        target_code = "220040" # 静岡県西部のターゲットコード
        ...
        # 中部北
        p_data = "**" + szs + " 中部北**\n"
        target_code = area_id[area] # 静岡県 中部北のターゲットコード
        ...
        # 中部南
        p_data = "**" + szs + " 中部南**\n"
        target_code = area_id[area] # 静岡県 中部南のターゲットコード
        ...
        # 伊豆北
        p_data = "**" + szs + " 伊豆北**\n"
        target_code = area_id[area] # 静岡県 伊豆北のターゲットコード
        ...
        # 伊豆南
        p_data = "**" + szs + " 伊豆南**\n"
        target_code = area_id[area] # 静岡県 伊豆南のターゲットコード
        ...
        # 富士山南東
        p_data = "**" + szs + " 富士山南東**\n"
        target_code = area_id[area] # 静岡県 富士山南東のターゲットコード
        ...
        # 富士山南西
        p_data = "**" + szs + " 富士山南西**\n"
        target_code = area_id[area] # 静岡県 富士山南西のターゲットコード
        ...
        # 遠州北
        p_data = "**" + szs + " 遠州北**\n"
        target_code = area_id[area] # 静岡県 遠州北のターゲットコード
        ...
        # 遠州南
        p_data = "**" + szs + " 遠州南**\n"
        target_code = area_id[area] # 静岡県 遠州南のターゲットコード
