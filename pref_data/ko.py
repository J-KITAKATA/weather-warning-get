...
# エリアのキーとコード
area_id = {"KO":"460011", "IS":"460012", "SA":"460013", "KS":"460014", "IK":"460015", "SO":"460021", "KM":"460022", "TN":"460031", "YK":"460032"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/kagoshima-NoAmami_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 薩摩地方
        p_data = "**" + pn + " 薩摩地方**\n"
        target_code = "460010" # 薩摩地方のターゲットコード
        ...
        # 大隈地方
        p_data = p_data + "\n" + "**" + pn + " 大隈地方**\n"
        target_code = "460020" # 大隈地方のターゲットコード
        ...
        # 種子島・種子島地方
        p_data = p_data + "\n" + "**" + pn + " 種子島・種子島地方**\n"
        target_code = "460030" # 種子島・種子島地方のターゲットコード
        ...
        # 鹿児島・日置
        p_data = "**" + pn + " 鹿児島・日置**\n"
        target_code = area_id[area] # 鹿児島・日置のターゲットコード
        ...
        # 出水・伊佐
        p_data = "**" + pn + " 出水・伊佐**\n"
        target_code = area_id[area] # 出水・伊佐のターゲットコード
        ...
        # 川薩・姶良
        p_data = "**" + pn + " 川薩・姶良**\n"
        target_code = area_id[area] # 川薩・姶良のターゲットコード
        ...
        # 甑島
        p_data = "**" + pn + " 甑島**\n"
        target_code = area_id[area] # 甑島のターゲットコード
        ...
        # 指宿・川辺
        p_data = "**" + pn + " 指宿・川辺**\n"
        target_code = area_id[area] # 指宿・川辺のターゲットコード
        ...
        # 曽於
        p_data = "**" + pn + " 曽於**\n"
        target_code = area_id[area] # 曽於のターゲットコード
        ...
        # 肝属
        p_data = "**" + pn + " 肝属**\n"
        target_code = area_id[area] # 肝属のターゲットコード
        ...
        # 種子島地方
        p_data = "**" + pn + " 種子島地方**\n"
        target_code = area_id[area] # 種子島地方のターゲットコード
        ...
        # 屋久島地方
        p_data = "**" + pn + " 屋久島地方**\n"
        target_code = area_id[area] # 屋久島地方のターゲットコード
