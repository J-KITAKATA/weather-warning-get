...
# エリアのキーとコード
area_id = {"KK":"260011", "NK":"260012", "YC":"260013", "YS":"260014", "TG":"260021","MA":"260022", "FC":"260023"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/kyoto_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 北部
        p_data = "**" + pn + " 北部**\n"
        target_code = "260020" # 北部のターゲットコード
        ...
        # 南部
        p_data = p_data + "\n" + "**" + pn + " 南部**\n"
        target_code = "260010" # 南部のターゲットコード
        ...
        # 京都・亀岡
        p_data = "**" + pn + " 京都・亀岡**\n"
        target_code = area_id[area] # 京都・亀岡のターゲットコード
        ...
        # 南丹・京丹波
        p_data = "**" + pn + " 南丹・京丹波**\n"
        target_code = area_id[area] # 南丹・京丹波のターゲットコード
        ...
        # 山城中部
        p_data = "**" + pn + " 山城中部**\n"
        target_code = area_id[area] # 山城中部のターゲットコード
        ...
        # 山城南部
        p_data = "**" + pn + " 山城南部**\n"
        target_code = area_id[area] # 山城南部のターゲットコード
        ...
        # 丹後
        p_data = "**" + pn + " 丹後**\n"
        target_code = area_id[area] # 丹後のターゲットコード
        ...
        # 舞鶴・綾部
        p_data = "**" + pn + " 舞鶴・綾部**\n"
        target_code = area_id[area] # 舞鶴・綾部のターゲットコード
        ...
        # 福知山
        p_data = "**" + pn + " 福知山**\n"
        target_code = area_id[area] # 福知山のターゲットコード
