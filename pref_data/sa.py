...
# エリアのキーとコード
area_id = {"SK":"410011", "TS":"410012", "TO":"410013", "KM":"410014", "KT":"410021", "IR":"410022"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/saga_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 北部
        p_data = "**" + pn + " 北部**\n"
        target_code = "410020" # 北部のターゲットコード
        ...
        # 南部
        p_data = p_data + "\n" + "**" + pn + " 南部**\n"
        target_code = "410010" # 南部のターゲットコード
        ...
        # 佐賀多久地区
        p_data = "**" + pn + " 佐賀多久地区**\n"
        target_code = area_id[area] # 佐賀多久地区のターゲットコード
        ...
        # 鳥栖地区
        p_data = "**" + pn + " 鳥栖地区**\n"
        target_code = area_id[area] # 鳥栖地区のターゲットコード
        ...
        # 武雄地区
        p_data = "**" + pn + " 武雄地区**\n"
        target_code = area_id[area] # 武雄地区のターゲットコード
        ...
        # 鹿島地区
        p_data = "**" + pn + " 鹿島地区**\n"
        target_code = area_id[area] # 鹿島地区のターゲットコード
        ...
        # 唐津地区
        p_data = "**" + pn + " 唐津地区**\n"
        target_code = area_id[area] # 唐津地区のターゲットコード
        ...
        # 伊万里地区
        p_data = "**" + pn + " 伊万里地区**\n"
        target_code = area_id[area] # 群馬県 伊万里地区のターゲットコード
