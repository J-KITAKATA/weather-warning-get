...
# エリアのキーとコード
area_id = {"AN":"460041", "AC":"460042", "TM":"460043"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/Amami_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 奄美地方
        p_data = "**" + pn + "**\n"
        target_code = "460040" # 奄美地方のターゲットコード
        ...
        # 十島村
        p_data = "**" + pn + " 十島村**\n"
        target_code = area_id[area] # 十島村のターゲットコード
