...
# エリアのキーとコード
area_id = {"TN":"360011", "MN":"360012", "MS":"360013", "MY":"360014", "AN":"360021", "NK":"360022", "KB":"360023"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/tokushima_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 北部
        p_data = "**" + pn + " 北部**\n"
        target_code = "360010" # 北部のターゲットコード
        ...
        # 南部
        p_data = p_data + "\n" + "**" + pn + " 南部**\n"
        target_code = "360020" # 南部のターゲットコード
        ...
        # 徳島・鳴門
        p_data = "**" + pn + " 徳島・鳴門**\n"
        target_code = area_id[area] # 徳島・鳴門のターゲットコード
        ...
        # 美馬北部・阿北
        p_data = "**" + pn + " 美馬北部・阿北**\n"
        target_code = area_id[area] # 美馬北部・阿北のターゲットコード
        ...
        # 美馬南部・神山
        p_data = "**" + pn + " 美馬南部・神山**\n"
        target_code = area_id[area] # 美馬南部・神山のターゲットコード
        ...
        # 三好
        p_data = "**" + pn + " 三好**\n"
        target_code = area_id[area] # 三好のターゲットコード
        ...
        # 阿南
        p_data = "**" + pn + " 阿南**\n"
        target_code = area_id[area] # 群馬県 阿南のターゲットコード
        ...
        # 那賀・勝浦
        p_data = "**" + pn + " 那賀・勝浦**\n"
        target_code = area_id[area] # 那賀・勝浦のターゲットコード
        ...
        # 海部
        p_data = "**" + pn + " 海部**\n"
        target_code = area_id[area] # 海部のターゲットコード
