...
# エリアのキーとコード
area_id = {"OC":"440010", "ON":"440020", "HK":"440031", "TD":"440032", "SI":"440041", "BO":"440042"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/ohita_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 中部
        p_data = "**" + pn + " 中部**\n"
        target_code = "440010" # 中部のターゲットコード
        ...
        # 北部
        p_data = p_data + "\n" + "**" + pn + " 北部**\n"
        target_code = "440020" # 北部のターゲットコード
        ...
        # 西部
        p_data = p_data + "\n" + "**" + pn + " 西部**\n"
        target_code = "440030" # 西部のターゲットコード
        ...
        # 南部
        p_data = p_data + "\n" + "**" + pn + " 南部**\n"
        target_code = "440040" # 南部のターゲットコード
        ...
        # 北部
        p_data = "**" + pn + " 北部**\n"
        target_code = area_id[area] # 北部のターゲットコード
        ...
        # 日田玖珠
        p_data = "**" + pn + " 日田玖珠**\n"
        target_code = area_id[area] # 日田玖珠のターゲットコード
        ...
        # 竹田市
        p_data = "**" + pn + " 竹田市**\n"
        target_code = area_id[area] # 竹田市のターゲットコード
        ...
        # 佐伯市
        p_data = "**" + pn + " 佐伯市**\n"
        target_code = area_id[area] # 佐伯市のターゲットコード
        ...
        # 豊後大野市
        p_data = "**" + pn + " 豊後大野市**\n"
        target_code = area_id[area] # 豊後大野市のターゲットコード
