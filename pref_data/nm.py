...
# エリアのキーとコード
area_id = {"NN":"014011", "NC":"014012", "NS":"014013"}
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 根室地方
        p_data = "**" + pn + "**\n"
        target_code = "014010" # 根室地方のターゲットコード
        ...
        # 根室北部
        p_data = "**" + pn + " 根室北部**\n"
        target_code = area_id[area] # 根室北部 のターゲットコード
        ...
        # 根室中部
        p_data = "**" + pn + " 根室中部**\n"
        target_code = area_id[area] # 根室中部 のターゲットコード
        ...
        # 根室南部
        p_data = "**" + pn + " 根室南部**\n"
        target_code = area_id[area] # 根室南部 のターゲットコード
