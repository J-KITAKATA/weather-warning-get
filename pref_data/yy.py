...
# エリアのキーとコード
area_id = {"SG":"474011", "KT":"474012", "YG":"474020"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/Yaeyama_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 石垣島地方
        p_data = "**" + pn + " 石垣島地方**\n"
        target_code = "474010" # 石垣島地方のターゲットコード
        ...
        # 与那国島地方
        p_data = p_data + "\n" + "**" + pn + " 与那国島地方**\n"
        target_code = "474020" # 与那国島地方のターゲットコード
        ...
        # 石垣市
        p_data = "**" + pn + " 石垣市**\n"
        target_code = area_id[area] # 石垣市のターゲットコード
        ...
        # 竹富町
        p_data = "**" + pn + " 竹富町**\n"
        target_code = area_id[area] # 竹富町のターゲットコード
        ...
        # 与那国島地方
        p_data = "**" + pn + " 与那国島地方**\n"
        target_code = area_id[area] # 与那国島地方のターゲットコード
