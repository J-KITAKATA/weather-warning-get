...
# エリアのキーとコード
area_id = {"MZ":"450011", "NK":"450012", "NH":"450021", "ST":"450022", "KE":"450031", "MJ":"450032", "TC":"450041", "SM":"450042"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/miyazaki_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 南部平野部
        p_data = "**" + pn + " 南部平野部**\n"
        target_code = "450010" # 南部平野部のターゲットコード
        ...
        # 北部平野部
        p_data = p_data + "\n" + "**" + pn + " 北部平野部**\n"
        target_code = "450020" # 北部平野部のターゲットコード
        ...
        # 南部山沿い
        p_data = p_data + "\n" + "**" + pn + " 南部山沿い**\n"
        target_code = "450030" # 南部山沿いのターゲットコード
        ...
        # 北部山沿い
        p_data = p_data + "\n" + "**" + pn + " 北部山沿い**\n"
        target_code = "450040" # 北部山沿いのターゲットコード
        ...
        # 宮崎地区
        p_data = "**" + pn + " 宮崎地区**\n"
        target_code = area_id[area] # 宮崎地区のターゲットコード
        ...
        # 日南・串間地区
        p_data = "**" + pn + " 日南・串間地区**\n"
        target_code = area_id[area] # 日南・串間地区のターゲットコード
        ...
        # 延岡・日向地区
        p_data = "**" + pn + " 延岡・日向地区**\n"
        target_code = area_id[area] # 延岡・日向地区のターゲットコード
        ...
        # 西都・高鍋地区
        p_data = "**" + pn + " 西都・高鍋地区**\n"
        target_code = area_id[area] # 西都・高鍋地区のターゲットコード
        ...
        # 小林・えびの地区
        p_data = "**" + pn + " 小林・えびの地区**\n"
        target_code = area_id[area] # 群馬県 小林・えびの地区のターゲットコード
        ...
        # 都城地区
        p_data = "**" + pn + " 都城地区**\n"
        target_code = area_id[area] # 都城地区のターゲットコード
        ...
        # 高千穂地区
        p_data = "**" + pn + " 高千穂地区**\n"
        target_code = area_id[area] # 高千穂地区のターゲットコード
        ...
        # 椎葉・美郷地区
        p_data = "**" + pn + " 椎葉・美郷地区**\n"
        target_code = area_id[area] # 椎葉・美郷地区のターゲットコード
