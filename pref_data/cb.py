...
# エリアのキーとコード
area_id = {"CC":"120011", "IM":"120012", "EK":"120013", "KK":"120021", "SN":"120022", "KT":"120031", "IA":"120032"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/chiba_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 北西部
        p_data = "**" + pn + " 北西部**\n"
        target_code = "120010" # 北西部のターゲットコード
        ...
        # 北東部
        p_data = p_data + "\n" + "**" + pn + " 北東部**\n"
        target_code = "120020" # 北東部のターゲットコード
        ...
        # 南部
        p_data = p_data + "\n" + "**" + pn + " 南部**\n"
        target_code = "120030" # 南部のターゲットコード
        ...
        # 千葉中央
        p_data = "**" + pn + " 千葉中央**\n"
        target_code = area_id[area] # 千葉中央のターゲットコード
        ...
        # 印旛
        p_data = "**" + pn + " 印旛**\n"
        target_code = area_id[area] # 印旛のターゲットコード
        ...
        # 東葛飾
        p_data = "**" + pn + " 東葛飾**\n"
        target_code = area_id[area] # 東葛飾のターゲットコード
        ...
        # 香取・海匝
        p_data = "**" + pn + " 香取・海匝**\n"
        target_code = area_id[area] # 香取・海匝のターゲットコード
        ...
        # 山武・長生
        p_data = "**" + pn + " 山武・長生**\n"
        target_code = area_id[area] # 山武・長生のターゲットコード
        ...
        # 君津
        p_data = "**" + pn + " 君津**\n"
        target_code = area_id[area] # 君津のターゲットコード
        ...
        # 夷隅・安房
        p_data = "**" + pn + " 夷隅・安房**\n"
        target_code = area_id[area] # 夷隅・安房のターゲットコード
