...
# エリアのキーとコード
area_id = {"ST":"020011", "NT":"020012", "WT":"020013", "CT":"020014", "SK":"020020", "SP":"020031", "KK":"020032"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/aomori_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 津軽
        p_data = "**" + pn + " 津軽**\n"
        target_code = "020010" # 津軽のターゲットコード
        ...
        # 下北
        p_data = p_data + "\n" +"**" + pn + " 下北**\n"
        target_code = "020020" # 下北のターゲットコード
        ...
        # 三八上北
        p_data = p_data + "\n" + "**" + pn + " 三八上北**\n"
        target_code = "020030" # 三八上北のターゲットコード
        ...
        # 南青津軽
        p_data = "**" + pn + " 南青津軽**\n"
        target_code = area_id[area] # 南青津軽のターゲットコード
        ...
        # 北五津軽
        p_data = "**" + pn + " 北五津軽**\n"
        target_code = area_id[area] # 北五津軽のターゲットコード
        ...
        # 西津軽
        p_data = "**" + pn + " 西津軽**\n"
        target_code = area_id[area] # 西津軽のターゲットコード
        ...
        # 中南津軽
        p_data = "**" + pn + " 中南津軽**\n"
        target_code = area_id[area] # 中南津軽のターゲットコード
        ...
        # 下北
        p_data = "**" + pn + " 下北**\n"
        target_code = area_id[area] # 下北のターゲットコード
        ...
        # 三八
        p_data = "**" + pn + " 三八**\n"
        target_code = area_id[area] # 三八のターゲットコード
        ...
        # 上北
        p_data = "**" + pn + " 上北**\n"
        target_code = area_id[area] # 上北のターゲットコード
