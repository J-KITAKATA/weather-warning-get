...
# エリアのキーとコード
area_id = {"KN":"014021", "KC":"014022", "KSE":"014023", "KSW":"014024"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/Nemu_Kushi-H_cache.json"
# フォルダを作成（すでにあればスルー）
# os.makedirs(os.path.dirname(CACHE_FILE), exist_ok=True)

safe_text = "警報・注意報の発表なし" # 発表されていない時用の出力

pn = "北海道 釧路地方" # 地域・エリアの名前
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 釧路地方
        p_data = "**" + pn + "**\n"
        target_code = "014020" # 釧路地方のターゲットコード
        ...
        # 釧路北部
        p_data = "**" + pn + " 釧路北部**\n"
        target_code = area_id[area] # 釧路北部 のターゲットコード
        ...
        # 釧路中部
        p_data = "**" + pn + " 釧路中部**\n"
        target_code = area_id[area] # 釧路中部 のターゲットコード
        ...
        # 釧路南東部
        p_data = "**" + pn + " 釧路南東部**\n"
        target_code = area_id[area] # 釧路南東部 のターゲットコード
        ...
        # 釧路南西部
        p_data = "**" + pn + " 釧路南西部**\n"
        target_code = area_id[area] # 釧路南西部 のターゲットコード
