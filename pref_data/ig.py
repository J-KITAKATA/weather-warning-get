...
# エリアのキーとコード
area_id = {"IC":"080011", "IN":"080012", "RO":"080021", "IS":"080022", "IW":"080023"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/ibaraki_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 北部
        p_data = "**" + pn + " 北部**\n"
        target_code = "080010" # 北部のターゲットコード
        ...
        # 南部
        p_data = p_data + "\n" + "**" + pn + " 南部**\n"
        target_code = "080020" # 南部のターゲットコード
        ...
        # 県央地域
        p_data = "**" + pn + " 県央地域**\n"
        target_code = area_id[area] # 県央地域のターゲットコード
        ...
        # 県北地域
        p_data = "**" + pn + " 県北地域**\n"
        target_code = area_id[area] # 県北地域のターゲットコード
        ...
        # 鹿行地域
        p_data = "**" + pn + " 鹿行地域**\n"
        target_code = area_id[area] # 鹿行地域のターゲットコード
        ...
        # 県南地域
        p_data = "**" + pn + " 県南地域**\n"
        target_code = area_id[area] # 県南地域のターゲットコード
        ...
        # 県西地域
        p_data = "**" + pn + " 県西地域**\n"
        target_code = area_id[area] # 県西地域のターゲットコード
