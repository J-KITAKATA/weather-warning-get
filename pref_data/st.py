...
# エリアのキーとコード
area_id = {"SC":"110011", "SE":"110012", "SW":"110013", "NE":"110021", "NW":"110022", "TB":"110030"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/saitama_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 北部
        p_data = "**" + pn + " 北部**\n"
        target_code = "110020" # 北部のターゲットコード
        ...
        # 南部
        p_data = p_data + "\n" + "**" + pn + " 南部**\n"
        target_code = "110010" # 南部のターゲットコード
        ...
        # 秩父地方
        p_data = p_data + "\n" + "**" + pn + " 秩父地方**\n"
        target_code = "110030" # 秩父地方のターゲットコード
        ...
        # 南中部
        p_data = "**" + pn + " 南中部**\n"
        target_code = area_id[area] # 南中部のターゲットコード
        ...
        # 南東部
        p_data = "**" + pn + " 南東部**\n"
        target_code = area_id[area] # 南東部のターゲットコード
        ...
        # 南西部
        p_data = "**" + pn + " 南西部**\n"
        target_code = area_id[area] # 南西部のターゲットコード
        ...
        # 北東部
        p_data = "**" + pn + " 北東部**\n"
        target_code = area_id[area] # 北東部のターゲットコード
        ...
        # 北西部
        p_data = "**" + pn + " 北西部**\n"
        target_code = area_id[area] # 北西部のターゲットコード
        ...
        # 秩父地方
        p_data = "**" + pn + " 秩父地方**\n"
        target_code = area_id[area] # 秩父地方のターゲットコード
