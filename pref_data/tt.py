...
# エリアのキーとコード
area_id = {"TT":"310011", "YT":"310012", "KY":"310021", "YG":"310022", "HN":"310023"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/tottori_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 東部
        p_data = "**" + pn + " 東部**\n"
        target_code = "310010" # 東部のターゲットコード
        ...
        # 中・西部
        p_data = p_data + "\n" + "**" + pn + " 中・西部**\n"
        target_code = "310020" # 中・西部のターゲットコード
        ...
        # 鳥取地区
        p_data = "**" + pn + " 鳥取地区**\n"
        target_code = area_id[area] # 鳥取地区のターゲットコード
        ...
        # 八頭地区
        p_data = "**" + pn + " 八頭地区**\n"
        target_code = area_id[area] # 八頭地区のターゲットコード
        ...
        # 倉吉
        p_data = "**" + pn + " 倉吉**\n"
        target_code = area_id[area] # 倉吉のターゲットコード
        ...
        # 米子地区
        p_data = "**" + pn + " 米子地区**\n"
        target_code = area_id[area] # 米子地区のターゲットコード
        ...
        # 日野地区
        p_data = "**" + pn + " 日野地区**\n"
        target_code = area_id[area] # 日野地区のターゲットコード
