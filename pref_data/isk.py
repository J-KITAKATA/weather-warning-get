...
# エリアのキーとコード
area_id = {"IKN":"016011", "IKC":"016012", "IKS":"016013"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/Ishi_Sora-H_cache.json"
# フォルダを作成（すでにあればスルー）
# os.makedirs(os.path.dirname(CACHE_FILE), exist_ok=True)

safe_text = "警報・注意報の発表なし" # 発表されていない時用の出力

pn = "北海道 石狩地方" # 地域・エリアの名前
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 石狩地方
        p_data = "**" + pn + "**\n"
        target_code = "016010" # 石狩地方のターゲットコード
        ...
        # 石狩北部
        p_data = "**" + pn + " 石狩北部**\n"
        target_code = area_id[area] # 石狩北部 のターゲットコード
        ...
        # 石狩中部
        p_data = "**" + pn + " 石狩中部**\n"
        target_code = area_id[area] # 石狩中部 のターゲットコード
        ...
        # 石狩南部
        p_data = "**" + pn + " 石狩南部**\n"
        target_code = area_id[area] # 石狩南部 のターゲットコード
