...
# エリアのキーとコード
area_id = {"MB":"420011", "NS":"420012", "OM":"420013", "SH":"420014", "HD":"420021", "SE":"420022", "IK":"420031", "UT":"420032", "VT":"420033", "UG":"420041", "VG":"420042"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/nagasaki_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 北部
        p_data = "**" + pn + " 北部**\n"
        target_code = "420020" # 北部のターゲットコード
        ...
        # 南部
        p_data = p_data + "\n" + "**" + pn + " 南部**\n"
        target_code = "420010" # 南部のターゲットコード
        ...
        # 五島
        p_data = p_data + "\n" + "**" + pn + " 五島**\n"
        target_code = "420040" # 五島のターゲットコード
        ...
        # 島原半島
        p_data = "**" + pn + " 島原半島**\n"
        target_code = area_id[area] # 島原半島のターゲットコード
        ...
        # 長崎地区
        p_data = "**" + pn + " 長崎地区**\n"
        target_code = area_id[area] # 長崎地区のターゲットコード
        ...
        # 諫早・大村地区
        p_data = "**" + pn + " 諫早・大村地区**\n"
        target_code = area_id[area] # 諫早・大村地区のターゲットコード
        ...
        # 西彼杵半島
        p_data = "**" + pn + " 西彼杵半島**\n"
        target_code = area_id[area] # 西彼杵半島のターゲットコード
        ...
        # 平戸・松浦地区
        p_data = "**" + pn + " 平戸・松浦地区**\n"
        target_code = area_id[area] # 平戸・松浦地区のターゲットコード
        ...
        # 佐世保・東彼地区
        p_data = "**" + pn + " 佐世保・東彼地区**\n"
        target_code = area_id[area] # 佐世保・東彼地区のターゲットコード
        ...
        # 壱岐
        p_data = "**" + pn + " 壱岐**\n"
        target_code = area_id[area] # 壱岐のターゲットコード
        ...
        # 上対馬
        p_data = "**" + pn + " 上対馬**\n"
        target_code = area_id[area] # 上対馬のターゲットコード
        ...
        # 下対馬
        p_data = "**" + pn + " 下対馬**\n"
        target_code = area_id[area] # 下対馬のターゲットコード
        ...
        # 上五島
        p_data = "**" + pn + " 上五島**\n"
        target_code = area_id[area] # 上五島のターゲットコード
        ...
        # 下五島
        p_data = "**" + pn + " 下五島**\n"
        target_code = area_id[area] # 下五島のターゲットコード
