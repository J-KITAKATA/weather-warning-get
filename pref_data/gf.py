...
# エリアのキーとコード
area_id = {"GS":"210011", "GE":"210012", "GC":"210013", "HN":"210021", "HS":"210022"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/gifu_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 美濃地方
        p_data = "**" + pn + " 美濃地方**\n"
        target_code = "210010" # 美濃地方のターゲットコード
        ...
        # 飛騨地方
        p_data = p_data + "\n" + "**" + pn + " 飛騨地方**\n"
        target_code = "210020" # 飛騨地方のターゲットコード
        ...
        # 岐阜・西濃
        p_data = "**" + pn + " 岐阜・西濃**\n"
        target_code = area_id[area] # 岐阜・西濃のターゲットコード
        ...
        # 東農
        p_data = "**" + pn + " 東農**\n"
        target_code = area_id[area] # 東農のターゲットコード
        ...
        # 中濃
        p_data = "**" + pn + " 中濃**\n"
        target_code = area_id[area] # 中濃のターゲットコード
        ...
        # 飛騨北部
        p_data = "**" + pn + " 飛騨北部**\n"
        target_code = area_id[area] # 飛騨北部のターゲットコード
        ...
        # 飛騨南部
        p_data = "**" + pn + " 飛騨南部**\n"
        target_code = area_id[area] # 飛騨南部のターゲットコード
