...
# エリアのキーとコード
area_id = {"KN":"012011", "KC":"012012","KS":"012013"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/kami&Rumoi-H_cache.json"
# フォルダを作成（すでにあればスルー）
# os.makedirs(os.path.dirname(CACHE_FILE), exist_ok=True)

safe_text = "警報・注意報の発表なし" # 発表されていない時用の出力

kmh = "北海道 上川地方" # 地域・エリアの名前
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 上川地方
        p_data = "**" + kmh + "**\n"
        target_code = "012010" # 上川地方のターゲットコード
        ...
        # 上川北部
        p_data = "**" + kmh + " 上川北部**\n"
        target_code = area_id[area] # 上川北部 のターゲットコード
        ...
        # 上川中部
        p_data = "**" + kmh + " 上川中部**\n"
        target_code = area_id[area] # 上川中部 のターゲットコード
        ...
        # 上川南部
        p_data = "**" + kmh + " 上川南部**\n"
        target_code = area_id[area] # 上川南部 のターゲットコード
