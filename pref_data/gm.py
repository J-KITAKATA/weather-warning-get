...
# エリアのキーとコード
area_id = {"MK":"100011", "IO":"100012", "TF":"100013", "TN":"100021", "AG":"100022"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/gumma_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 北部
        p_data = "**" + pn + " 北部**\n"
        target_code = "100020" # 群馬県北部のターゲットコード
        ...
        # 南部
        p_data = p_data + "\n" + "**" + pn + " 南部**\n"
        target_code = "100010" # 群馬県南部のターゲットコード
        ...
        # 伊勢崎・太田地域
        p_data = "**" + pn + " 伊勢崎・太田地域**\n"
        target_code = area_id[area] # 群馬県 伊勢崎・太田地域のターゲットコード
        ...
        # 高崎・藤岡地域
        p_data = "**" + pn + " 高崎・藤岡地域**\n"
        target_code = area_id[area] # 群馬県 高崎・藤岡地域のターゲットコード
        ...
        # 利根・沼田地域
        p_data = "**" + pn + " 利根・沼田地域**\n"
        target_code = area_id[area] # 群馬県 利根・沼田地域のターゲットコード
        ...
        # 我妻地域
        p_data = "**" + pn + " 我妻地域**\n"
        target_code = area_id[area] # 群馬県 我妻地域のターゲットコード
