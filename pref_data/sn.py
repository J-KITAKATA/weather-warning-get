...
# エリアのキーとコード
area_id = {"ME":"320011","IZ":"320012","US":"320013", "HM":"320021", "MS":"320023", "IK":"320030"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/shimane_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 東部
        p_data = "**" + pn + " 東部**\n"
        target_code = "320010" # 東部のターゲットコード
        ...
        # 西部
        p_data = p_data + "\n" + "**" + pn + " 西部**\n"
        target_code = "320020" # 西部のターゲットコード
        ...
        # 松江地区
        p_data = "**" + pn + " 松江地区**\n"
        target_code = area_id[area] # 松江地区のターゲットコード
        ...
        # 出雲地区
        p_data = "**" + pn + " 出雲地区**\n"
        target_code = area_id[area] # 出雲地区のターゲットコード
        ...
        # 雲南地区
        p_data = "**" + pn + " 雲南地区**\n"
        target_code = area_id[area] # 雲南地区のターゲットコード
        ...
        # 浜田地区
        p_data = "**" + pn + " 浜田地区**\n"
        target_code = area_id[area] # 浜田地区のターゲットコード
        ...
        # 益田地区
        p_data = "**" + pn + " 益田地区**\n"
        target_code = area_id[area] # 益田地区のターゲットコード
        ...
        # 隠岐
        p_data = "**" + pn + " 隠岐**\n"
        target_code = area_id[area] # 隠岐のターゲットコード
