...
# エリアのキーとコード
area_id = {"SS":"350011", "UD":"350012", "YF":"350021", "ST":"350022", "WK":"350031", "YH":"350032", "HB":"350041", "NG":"350042"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/yamaguchi_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 西部
        p_data = "**" + pn + " 西部**\n"
        target_code = "350010" # 西部のターゲットコード
        ...
        # 中部
        p_data = p_data + "\n" + "**" + pn + " 中部**\n"
        target_code = "350020" # 中部のターゲットコード
        ...
        # 東部
        p_data = p_data + "\n" + "**" + pn + " 東部**\n"
        target_code = "350030" # 東部のターゲットコード
        ...
        # 北部
        p_data = p_data + "\n" + "**" + pn + " 北部**\n"
        target_code = "350040" # 北部のターゲットコード
        ...
        # 下関
        p_data = "**" + pn + " 下関**\n"
        target_code = area_id[area] # 下関のターゲットコード
        ...
        # 宇部・山陽小野田
        p_data = "**" + pn + " 宇部・山陽小野田**\n"
        target_code = area_id[area] # 宇部・山陽小野田のターゲットコード
        ...
        # 山口・防府
        p_data = "**" + pn + " 山口・防府**\n"
        target_code = area_id[area] # 山口・防府のターゲットコード
        ...
        # 周南・下松
        p_data = "**" + pn + " 周南・下松**\n"
        target_code = area_id[area] # 周南・下松のターゲットコード
        ...
        # 岩国
        p_data = "**" + pn + " 岩国**\n"
        target_code = area_id[area] # 岩国のターゲットコード
        ...
        # 柳井・光
        p_data = "**" + pn + " 柳井・光**\n"
        target_code = area_id[area] # 柳井・光のターゲットコード
        ...
        # 萩・美弥
        p_data = "**" + pn + " 萩・美弥**\n"
        target_code = area_id[area] # 萩・美弥のターゲットコード
        ...
        # 長門
        p_data = "**" + pn + " 長門**\n"
        target_code = area_id[area] # 長門のターゲットコード
