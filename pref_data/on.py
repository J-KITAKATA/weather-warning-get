...
# エリアのキーとコード
area_id = {"OS":"471011", "OC":"471012", "KG":"471013", "ZH":"471021", "KN":"471022", "NG":"471023", "NC":"471024", "KM":"471030"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/Okinawa-Main_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 本島中南部
        p_data = "**" + pn + " 本島中南部**\n"
        target_code = "471010" # 本島中南部のターゲットコード
        ...
        # 本島北部
        p_data = p_data + "\n" + "**" + pn + " 本島北部**\n"
        target_code = "471020" # 本島北部のターゲットコード
        ...
        # 久米島
        p_data = p_data + "\n" + "**" + pn + " 久米島**\n"
        target_code = "471030" # 久米島のターゲットコード
        ...
        # 南部
        p_data = "**" + pn + " 南部**\n"
        target_code = area_id[area] # 南部のターゲットコード
        ...
        # 中部
        p_data = "**" + pn + " 中部**\n"
        target_code = area_id[area] # 中部のターゲットコード
        ...
        # 慶良間・栗国諸島
        p_data = "**" + pn + " 慶良間・栗国諸島**\n"
        target_code = area_id[area] # 慶良間・栗国諸島のターゲットコード
        ...
        # 伊是名・伊平屋
        p_data = "**" + pn + " 伊是名・伊平屋**\n"
        target_code = area_id[area] # 伊是名・伊平屋のターゲットコード
        ...
        # 国頭地区
        p_data = "**" + pn + " 国頭地区**\n"
        target_code = area_id[area] # 国頭地区のターゲットコード
        ...
        # 名護地区
        p_data = "**" + pn + " 名護地区**\n"
        target_code = area_id[area] # 名護地区のターゲットコード
        ...
        # 恩名・金武地区
        p_data = "**" + pn + " 恩名・金武地区**\n"
        target_code = area_id[area] # 恩名・金武地区のターゲットコード
        ...
        # 久米島
        p_data = "**" + pn + " 久米島**\n"
        target_code = area_id[area] # 久米島のターゲットコード
