...
# エリアのキーとコード
area_id = {"OE":"230011", "OW":"230012", "TT":"230013", "WS":"230014", "WNW":"230015", "WNE":"230021", "EN":"230022", "ES":"230023"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/aichi_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 東部
        p_data = "**" + pn + " 東部**\n"
        target_code = "230020" # 東部のターゲットコード
        ...
        # 西部
        p_data = p_data + "\n" + "**" + pn + " 西部**\n"
        target_code = "230010" # 西部のターゲットコード
        ...
        # 尾張東部
        p_data = "**" + pn + " 尾張東部**\n"
        target_code = area_id[area] # 尾張東部のターゲットコード
        ...
        # 尾張西部
        p_data = "**" + pn + " 尾張西部**\n"
        target_code = area_id[area] # 尾張西部のターゲットコード
        ...
        # 知多地域
        p_data = "**" + pn + " 知多地域**\n"
        target_code = area_id[area] # 知多地域のターゲットコード
        ...
        # 西三河南部
        p_data = "**" + pn + " 西三河南部**\n"
        target_code = area_id[area] # 西三河南部のターゲットコード
        ...
        # 西三河北西部
        p_data = "**" + pn + " 西三河北西部**\n"
        target_code = area_id[area] # 西三河北西部のターゲットコード
        ...
        # 西三河北東部
        p_data = "**" + pn + " 西三河北東部**\n"
        target_code = area_id[area] # 西三河北東部のターゲットコード
        ...
        # 東三河北部
        p_data = "**" + pn + " 東三河北部**\n"
        target_code = area_id[area] # 東三河北部のターゲットコード
        ...
        # 東三河南部
        p_data = "**" + pn + " 東三河南部**\n"
        target_code = area_id[area] # 東三河南部のターゲットコード
