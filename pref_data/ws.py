...
# エリアのキーとコード
area_id = {"WN":"017011", "WE":"017012", "WW":"017013"}
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 渡島地方
        p_data = "**" + pn + "**\n"
        target_code = "017010" # 渡島地方のターゲットコード
        ...
        # 渡島北部
        p_data = "**" + pn + " 渡島北部**\n"
        target_code = area_id[area] # 渡島北部 のターゲットコード
        ...
        # 渡島東部
        p_data = "**" + pn + " 渡島東部**\n"
        target_code = area_id[area] # 渡島東部 のターゲットコード
        ...
        # 渡島西部
        p_data = "**" + pn + " 渡島西部**\n"
        target_code = area_id[area] # 渡島西部 のターゲットコード
