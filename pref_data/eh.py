...
# エリアのキーとコード
area_id = {"NY":"380010", "EE":"380021", "EW":"380022", "SN":"380031", "SS":"380032"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/ehime_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 中予
        p_data = "**" + pn + " 中予**\n"
        target_code = "380010" # 中予のターゲットコード
        ...
        # 東予
        p_data = p_data + "\n" + "**" + pn + " 東予**\n"
        target_code = "380020" # 東予のターゲットコード
        ...
        # 南予
        p_data = p_data + "\n" + "**" + pn + " 南予**\n"
        target_code = "380030" # 南予のターゲットコード
        ...
        # 中予
        p_data = "**" + pn + " 中予**\n"
        target_code = area_id[area] # 中予のターゲットコード
        ...
        # 東予東部
        p_data = "**" + pn + " 東予東部**\n"
        target_code = area_id[area] # 東予東部のターゲットコード
        ...
        # 東予西部
        p_data = "**" + pn + " 東予西部**\n"
        target_code = area_id[area] # 東予西部のターゲットコード
        ...
        # 南予北部
        p_data = "**" + pn + " 南予北部**\n"
        target_code = area_id[area] # 南予北部のターゲットコード
        ...
        # 南予南部
        p_data = "**" + pn + " 南予南部**\n"
        target_code = area_id[area] # 南予南部のターゲットコード
