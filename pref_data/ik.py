...
# エリアのキーとコード
area_id = {"KN":"170011", "KS":"170012", "NN":"170021", "NS":"170022"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/ishikawa_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 加賀
        p_data = "**" + pn + " 加賀**\n"
        target_code = "170010" # 加賀のターゲットコード
        ...
        # 能登
        p_data = p_data + "\n" + "**" + pn + " 能登**\n"
        target_code = "170020" # 能登のターゲットコード
        ...
        # 加賀北部
        p_data = "**" + pn + " 加賀北部**\n"
        target_code = area_id[area] # 加賀北部のターゲットコード
        ...
        # 加賀南部
        p_data = "**" + pn + " 加賀南部**\n"
        target_code = area_id[area] # 加賀南部のターゲットコード
        ...
        # 能登北部
        p_data = "**" + pn + " 能登北部**\n"
        target_code = area_id[area] # 能登北部のターゲットコード
        ...
        # 能登南部
        p_data = "**" + pn + " 能登南部**\n"
        target_code = area_id[area] # 能登南部のターゲットコード
