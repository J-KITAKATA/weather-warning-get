...
# エリアのキーとコード
area_id = {"NN":"180011", "NS":"180012", "OE":"180013", "SE":"180021", "SW":"180022"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/fukui_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 峯北
        p_data = "**" + pn + " 峯北**\n"
        target_code = "180010" # 峯北のターゲットコード
        ...
        # 峯南
        p_data = p_data + "\n" + "**" + pn + " 峯南**\n"
        target_code = "180020" # 峯南のターゲットコード
        ...
        # 峯北北部
        p_data = "**" + pn + " 峯北北部**\n"
        target_code = area_id[area] # 峯北北部のターゲットコード
        ...
        # 峯北南部
        p_data = "**" + pn + " 峯北南部**\n"
        target_code = area_id[area] # 峯北南部のターゲットコード
        ...
        # 奥越
        p_data = "**" + pn + " 奥越**\n"
        target_code = area_id[area] # 奥越のターゲットコード
        ...
        # 峯南東部
        p_data = "**" + pn + " 峯南東部**\n"
        target_code = area_id[area] # 峯南東部のターゲットコード
        ...
        # 峯南西部
        p_data = "**" + pn + " 峯南西部**\n"
        target_code = area_id[area] # 峯南西部のターゲットコード
