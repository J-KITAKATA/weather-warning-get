...
# エリアのキーとコード
area_id = {"KN":"300011", "KC":"300012", "TW":"300021", "SE":"300022"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/wakayama_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 北部
        p_data = "**" + pn + " 北部**\n"
        target_code = "300010" # 北部のターゲットコード
        ...
        # 南部
        p_data = p_data + "\n" + "**" + pn + " 南部**\n"
        target_code = "300020" # 南部のターゲットコード
        ...
        # 紀北
        p_data = "**" + pn + " 紀北**\n"
        target_code = area_id[area] # 紀北のターゲットコード
        ...
        # 田辺・西牟婁
        p_data = "**" + pn + " 田辺・西牟婁**\n"
        target_code = area_id[area] # 田辺・西牟婁のターゲットコード
        ...
        # 新宮・東牟婁
        p_data = "**" + pn + " 新宮・東牟婁**\n"
        target_code = area_id[area] # 群馬県 新宮・東牟婁のターゲットコード
