...
# エリアのキーとコード
area_id = {"TC":"090011", "SE":"090012", "SW":"090013", "NS":"090021", "NK":"090022"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/totigi_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 北部
        p_data = "**" + pn + " 北部**\n"
        target_code = "090020" # 北部のターゲットコード
        ...
        # 南部
        p_data = p_data + "\n" + "**" + pn + " 南部**\n"
        target_code = "090010" # 北部のターゲットコード
        ...
        # 県央部
        p_data = "**" + pn + " 県央部**\n"
        target_code = area_id[area] # 県央部のターゲットコード
        ...
        # 那須地域
        p_data = "**" + pn + " 那須地域**\n"
        target_code = area_id[area] # 那須地域のターゲットコード
        ...
        # 日光市
        p_data = "**" + pn + " 日光市**\n"
        target_code = area_id[area] # 日光市のターゲットコード
