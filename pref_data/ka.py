...
# エリアのキーとコード
area_id = {"TK":"370001", "SD":"370002", "EK":"370003", "CK":"370004", "WK":"370005"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/kagawa_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 香川県
        p_data = "**" + pn + "**\n"
        target_code = "370000" # 香川県のターゲットコード
        ...
        # 高松地域
        p_data = "**" + pn + " 高松地域**\n"
        target_code = area_id[area] # 群馬県 高松地域のターゲットコード
        ...
        # 小豆
        p_data = "**" + pn + " 小豆**\n"
        target_code = area_id[area] # 小豆のターゲットコード
        ...
        # 東讃
        p_data = "**" + pn + " 東讃**\n"
        target_code = area_id[area] # 東讃のターゲットコード
        ...
        # 中讃
        p_data = "**" + pn + " 中讃**\n"
        target_code = area_id[area] # 中讃のターゲットコード
        ...
        # 西讃
        p_data = "**" + pn + " 西讃**\n"
        target_code = area_id[area] # 西讃のターゲットコード
