...
# エリアのキーとコード
area_id = {"YK":"140011", "SN":"140012", "MU":"140013", "SH":"140021", "SC":"140022", "AG":"140023", "SS":"140024"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/kanagawa_cache.json"
# フォルダを作成（すでにあればスルー）
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 東部
        p_data = "**" + kng + " 東部**\n"
        target_code = "140010" # 東部のターゲットコード
        ...
        # 西部
        p_data = p_data + "\n" + "**" + kng + " 西部**\n"
        target_code = "140020" # 西部のターゲットコード
        ...
        # 横浜・川崎
        p_data = "**" + kng + " 横浜・川崎**\n"
        target_code = area_id[area] # 神奈川県 横浜・川崎のターゲットコード
        ...
        # 湘南
        p_data = "**" + kng + " 湘南**\n"
        target_code = area_id[area] # 神奈川県 湘南のターゲットコード
        ...
        # 三浦半島
        p_data = "**" + kng + " 三浦半島**\n"
        target_code = area_id[area] # 神奈川県 三浦半島のターゲットコード
        ...
        # 相模原
        p_data = "**" + kng + " 相模原**\n"
        target_code = area_id[area] # 神奈川県 相模原のターゲットコード
        ...
        # 県央
        p_data = "**" + kng + " 県央**\n"
        target_code = area_id[area] # 神奈川県 県央のターゲットコード
        ...
        # 足柄上
        p_data = "**" + kng + " 足柄上**\n"
        target_code = area_id[area] # 神奈川県 足柄上のターゲットコード
        ...
        # 西湘
        p_data = "**" + kng + " 西湘**\n"
        target_code = area_id[area] # 神奈川県 西湘のターゲットコード
