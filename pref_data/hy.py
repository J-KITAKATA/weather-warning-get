...
# エリアのキーとコード
area_id = {"HN":"017021", "HS":"017022", "HO":"017023"}
...
# キャッシュを保存するファイル名
CACHE_FILE = "./cache/Wata_Hiya-H_cache.json"
# フォルダを作成（すでにあればスルー）
# os.makedirs(os.path.dirname(CACHE_FILE), exist_ok=True)

safe_text = "警報・注意報の発表なし" # 発表されていない時用の出力

pn = "北海道 檜山地方" # 地域・エリアの名前
...
def pros(url, area, n_time):
    ...
    if area == None or area == "":
        # 檜山地方
        p_data = "**" + pn + "**\n"
        target_code = "017020" # 檜山地方のターゲットコード
        ...
        # 檜山北部
        p_data = "**" + pn + " 檜山北部**\n"
        target_code = area_id[area] # 檜山北部 のターゲットコード
        ...
        # 檜山南部
        p_data = "**" + pn + " 檜山南部**\n"
        target_code = area_id[area] # 檜山南部 のターゲットコード
        ...
        # 檜山奥尻島
        p_data = "**" + pn + " 檜山奥尻島**\n"
        target_code = area_id[area] # 檜山奥尻島 のターゲットコード
